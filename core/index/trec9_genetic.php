...
if ('xapian' == $clsid)
	$bm25 = $index->getWeightingScheme();
else {
	require_once 'core/index/plugin/bm25.class.inc';
	$bm25 = new BM25WeightingScheme();
	$index->loadExtension($bm25);
}

$trec9 = new Trec9IndexEvaluator($argv[1], $argv[2]);
$mediator = new SyndGeneticMediator($trec9, $index, $bm25);
$genetic  = new SyndGeneticOptimizer($mediator);
$genetic->run();
