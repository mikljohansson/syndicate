<table style="border:0;">
	<tr>
		<td style="padding:0; width:70%;">
			...
			<ul class="Actions">
				<li><a href="<?= tpl_link_call($node->getHandler(),'invoke',$node->nodeId,'receipt.pdf') ?>"><?= tpl_text('Download receipt (PDF)') ?></a></li>
				<li><a href="<?= tpl_link_call($node->getHandler(),'invoke',$node->nodeId,'printReceipt') ?>"><?= tpl_text('Print receipt') ?></a></li>
			</ul>
