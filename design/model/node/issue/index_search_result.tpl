...
<div class="SearchResult">
	<h3><a href="<?= tpl_link($node->getHandler(),$node->objectId()) ?>"><?= synd_htmlspecialchars($node->getTitle()) ?></a></h3>
	...
	<div class="Abstract"><?= SyndHTML::getContextSummary(wordwrap(synd_htmlspecialchars($node->getDescription()),70,' '), $highlight, 300) ?></div>
